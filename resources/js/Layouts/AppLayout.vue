                    ...
                    <div class="flex justify-between items-center h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <Link :href="user ? route('dashboard') : route('landing')">
                                        ...
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 pr-2" fill="none"
                                                    ...
                                                    id="winery"
                                                    v-if="$page.props.user.current_team.type == 'winery'"
                                                >
...
<!--                                        </jet-dropdown-link>-->
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1" v-if="user">
                        ...
                        <jet-responsive-nav-link :href="route('wineries.index')"
                            :active="route().current('wineries.index')">
                            Wineries
                        </jet-responsive-nav-link>
                    </div>
                    ...
                    <div class="pt-4 pb-4 border-t border-b border-gray-200">
                        <div class="flex items-center px-4 flex-col" v-if="! user">
                            <Link :href="route('login')" class="text-base leading-6 font-medium hover:text-gray-600 transition-colors duration-200 py-2">
                                Log In
                            </Link>
                        ...
                        <div class="flex items-center px-4" v-else>
...
<!--                            </jet-responsive-nav-link>-->
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <template v-for="team in $page.props.user.all_teams" :key="team.id">
                                    <form @submit.prevent="switchToTeam(team)">
                                        <jet-responsive-nav-link as="button" id="check">
                                            <div class="flex items-center">
                                                <svg v-if="team.id == $page.props.user.current_team_id"
                                                    class="mr-2 h-5 w-5 text-green-400" fill="none"
                                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
