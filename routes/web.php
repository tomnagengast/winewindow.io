...
Route::get('{winery}', [WineryController::class, 'show'])->name('wineries.show')->middleware('iframe');

Route::get('{winery}/{bottle}', [BottleController::class, 'show'])->name('bottles.show')->middleware('iframe');
